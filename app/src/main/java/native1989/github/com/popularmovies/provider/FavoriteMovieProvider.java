package native1989.github.com.popularmovies.provider;
...
public class FavoriteMovieProvider extends ContentProvider {
    ...
    static final String PROVIDER_NAME = "native1989.github.com.popularmovies";
    ...
    public boolean onCreate() {
        FavoriteData data = new FavoriteData(getContext());
    ...
    public String getType(Uri uri) {
        if (uriMatcher.match(uri) == FAVORITES) {
            return "vnd.android.cursor.dir/vnd.movie.favorites";
        } else {
